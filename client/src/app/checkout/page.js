...
export default function Checkout() {
  ...
  const stripePromise = loadStripe(
    "pk_test_51O1DHsIEWSsSQMqfOGwf3tEfv6IAF79YjOL74fiCc9GU8X9Q2Id3LjCh2uiGD7EGRiUXkJIrDDu82nQdS5USgIWH003Wt4iEXd"
  );
      ...
      if (
        ...
        const createFinalCheckoutFormData = {
          ...
          totalPrice: cartItems.reduce(
            (total, item) => Number(item.price) + Number(total),
            0
          ),
          isPaid: true,
          isProcessing: true,
                ...
                >
                  ...
                  <div className="flex w-full flex-col px-4 py-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-xs font-semibold">Qty {item.qty}</p>
                    </div>
                  </div>
                </div>
              ))
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <div className="mt-6 border-t border-b py-2">
            <div className="flex items-center justify-between">
              ...
              <p className="text-lg font-bold text-gray-900">
                {cartItems && cartItems.length
                  ? cartItems.reduce(
                      (total, item) =>
                        parseFloat(item.price) * item.qty + parseFloat(total),
                      0
                    )
                  : 0}{" "}
                DT
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="text-lg font-bold text-gray-900">7 DT</p>
            </div>
            <div className="flex items-center justify-between">
